...
function CalendarHeading(props: React.HTMLAttributes<HTMLElement>) {
  ...
  return (
    <header className="flex w-full items-center gap-1 px-1 pb-4" {...props}>
      <AriaButton
        slot="previous"
        className={cn(
          ariaButtonVariants({ variant: "outline" }),
...
function CalendarGrid({ className, ...props }: AriaCalendarGridProps) {
  return (
    <AriaCalendarGrid
      className={cn(
...
function CalendarGridHeader({ ...props }: AriaCalendarGridHeaderProps) {
...
function CalendarCell({ className, ...props }: AriaCalendarCellProps) {
  const isRange = Boolean(React.useContext(AriaRangeCalendarStateContext));
  return (
    <AriaCalendarCell
      className={composeRenderProps(className, (className, renderProps) =>
        cn(
          ariaButtonVariants({ variant: "ghost" }),
