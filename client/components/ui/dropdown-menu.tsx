...
>(({ className, children, checked, ...props }, ref) => (
  ...
  >
    <span
      className={cn(
        "absolute left-2 flex size-4 items-center justify-center rounded-xs border border-border bg-card transition-colors",
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    <span
      className={cn(
        "absolute left-2 flex size-4 items-center justify-center rounded-full border border-border bg-card transition-colors",
