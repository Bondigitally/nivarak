  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        className={cn(
          "flex max-h-[min(92vh,880px)] w-[calc(100%-2rem)] max-w-160 flex-col gap-0 overflow-hidden rounded-[20px] border border-[#E9E4ED] bg-white p-0 shadow-[0_12px_24px_-4px_rgba(17,24,39,0.12)] outline-none sm:max-w-160",
        )}
        onOpenAutoFocus={(event) => {
          // Keep focus in the dialog without jumping into the first date chip.
      ...
      >
        ...
        <DialogBody className="flex min-h-0 flex-1 flex-col gap-6 overflow-x-hidden overflow-y-auto overscroll-contain px-6 py-6 sm:gap-8 sm:px-8 sm:py-7">
