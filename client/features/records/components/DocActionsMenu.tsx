    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-45 rounded-md border border-border bg-card p-1 shadow-lg">
        ...
        <DropdownMenuItem className="flex cursor-pointer items-center gap-2 rounded-md px-3 py-2 text-sm text-muted-foreground hover:bg-background hover:text-primary">
          <HugeiconsIcon icon={Download01Icon} size={19} strokeWidth={1.5} color="currentColor" absoluteStrokeWidth />
          Download
        </DropdownMenuItem>
        <DropdownMenuItem className="flex cursor-pointer items-center gap-2 rounded-sm px-3 py-2 text-sm text-destructive hover:bg-destructive-muted hover:text-destructive">
          <HugeiconsIcon icon={Delete01Icon} size={19} strokeWidth={1.5} color="currentColor" absoluteStrokeWidth />
          Delete
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
