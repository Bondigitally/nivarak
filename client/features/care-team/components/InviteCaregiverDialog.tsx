...
export function InviteCaregiverDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className={cn(
          "flex max-h-[min(92vh,900px)] w-[calc(100%-2rem)] max-w-160 flex-col gap-0 overflow-hidden rounded-[20px] border border-[#E9E0E8] bg-white p-0 shadow-[0_12px_24px_-4px_rgba(17,24,39,0.12)] sm:max-w-160",
        )}
      >
